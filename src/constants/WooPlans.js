 ...
 */
 ...
 export const SHIPPING_COST = 6.50;
 ...
 export const CONSUMER_PLANS = {
     everyday_exceptional:   {
         ...
         description:            "Perfect for a glass with your evening meal or with friends, or anytime really.",
     ...
     [PLAN_EXQUISITE_ENTERTAINING]: {
         ...
         description:            "Undiscovered gems and perfect companions to meals and entertaining with a wow factor.",
     ...
     stellar_selection:      {
         ...
         description:            "You won’t want to share these wines from top winemakers around the world.",
  ...
  */
 each(['everyday_exceptional', 'exquisite_entertaining', 'stellar_selection'], (plan) => {
 ...
 giftCards.everyday_exceptional.variations.bottles_1.sku          = 'everyday-exceptional-gift-card-1-bottle';
 
 giftCards.everyday_exceptional.variations.bottles_3.variation_id = 9705;
 giftCards.everyday_exceptional.variations.bottles_3.sku          = 'everyday-exceptional-gift-card-3-bottles';
 
 giftCards.everyday_exceptional.variations.bottles_6.variation_id = 9707;
 giftCards.everyday_exceptional.variations.bottles_6.sku          = 'everyday-exceptional-gift-card-6-bottles';
 
 giftCards.everyday_exceptional.variations.bottles_12.variation_id = 9710;
 giftCards.everyday_exceptional.variations.bottles_12.sku          = 'everyday-exceptional-gift-card-12-bottles';
 
 /**
  * EXQUISITE ENTERTAINING
  */
 giftCards.exquisite_entertaining.variations.bottles_1.variation_id = 9703;
 giftCards.exquisite_entertaining.variations.bottles_1.sku          = 'exquisite-entertaining-gift-card-1-bottle';
 
 giftCards.exquisite_entertaining.variations.bottles_3.variation_id = 9706;
 giftCards.exquisite_entertaining.variations.bottles_3.sku          = 'exquisite-entertaining-gift-card-3-bottles';
 
 giftCards.exquisite_entertaining.variations.bottles_6.variation_id = 9709;
 giftCards.exquisite_entertaining.variations.bottles_6.sku          = 'exquisite-entertaining-gift-card-6-bottles';
 
 giftCards.exquisite_entertaining.variations.bottles_12.variation_id = 9712;
 giftCards.exquisite_entertaining.variations.bottles_12.sku          = 'exquisite-entertaining-gift-card-12-bottles';
 
 /**
  * STELLAR SELECTION
  */
 giftCards.stellar_selection.variations.bottles_1.variation_id = 9704;
 giftCards.stellar_selection.variations.bottles_1.sku          = 'stellar-selection-gift-card-1-bottle';
 
 giftCards.stellar_selection.variations.bottles_3.variation_id = 9708;
 giftCards.stellar_selection.variations.bottles_3.sku          = 'stellar-selection-gift-card-3-bottles';
 
 giftCards.stellar_selection.variations.bottles_6.variation_id = 9711;
 giftCards.stellar_selection.variations.bottles_6.sku          = 'stellar-selection-gift-card-6-bottles';
 
 giftCards.stellar_selection.variations.bottles_12.variation_id = 9713;
 giftCards.stellar_selection.variations.bottles_12.sku          = 'stellar-selection-gift-card-12-bottles';
 ...
 giftingPlans.everyday_exceptional.variations.bottles_1.sku          = 'everyday-exceptional-gift-1-bottle';
 
 giftingPlans.everyday_exceptional.variations.bottles_3.variation_id = 9273;
 giftingPlans.everyday_exceptional.variations.bottles_3.sku          = 'everyday-exceptional-gift-3-bottles';
 
 giftingPlans.everyday_exceptional.variations.bottles_6.variation_id = 9274;
 giftingPlans.everyday_exceptional.variations.bottles_6.sku          = 'everyday-exceptional-gift-6-bottles';
 
 giftingPlans.everyday_exceptional.variations.bottles_12.variation_id = 9275;
 giftingPlans.everyday_exceptional.variations.bottles_12.sku          = 'everyday-exceptional-gift-12-bottles';
 ...
 giftingPlans.exquisite_entertaining.variations.bottles_1.sku          = 'exquisite-entertaining-gift-1-bottle';
 
 giftingPlans.exquisite_entertaining.variations.bottles_3.variation_id = 9278;
 giftingPlans.exquisite_entertaining.variations.bottles_3.sku          = 'exquisite-entertaining-gift-3-bottles';
 
 giftingPlans.exquisite_entertaining.variations.bottles_6.variation_id = 9279;
 giftingPlans.exquisite_entertaining.variations.bottles_6.sku          = 'exquisite-entertaining-gift-6-bottles';
 
 giftingPlans.exquisite_entertaining.variations.bottles_12.variation_id = 9280;
 giftingPlans.exquisite_entertaining.variations.bottles_12.sku          = 'exquisite-entertaining-gift-12-bottles';
 ...
 giftingPlans.stellar_selection.variations.bottles_1.sku          = 'stellar-selection-gift-1-bottle';
 
 giftingPlans.stellar_selection.variations.bottles_3.variation_id = 9283;
 giftingPlans.stellar_selection.variations.bottles_3.sku          = 'stellar-selection-gift-3-bottles';
 
 giftingPlans.stellar_selection.variations.bottles_6.variation_id = 9284;
 giftingPlans.stellar_selection.variations.bottles_6.sku          = 'stellar-selection-gift-6-bottles';
 
 giftingPlans.stellar_selection.variations.bottles_12.variation_id = 9285;
 giftingPlans.stellar_selection.variations.bottles_12.sku          = 'stellar-selection-gift-12-bottles';
